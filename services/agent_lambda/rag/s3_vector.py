...
def retrieve_utd_context(question: str) -> str:
    ...
    if vectors:
        print("sample metadata:", vectors[0].get("metadata"))
...
- Resent 3 Job openings for the position so that students can identify requirements 
